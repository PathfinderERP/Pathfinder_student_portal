...
from master_data.models import Chapter, ClassLevel, Subject

def import_chapters(csv_path):
    print(f"Importing chapters from {csv_path}...")
    with open(csv_path, 'r', encoding='windows-1252') as f:
        # Check for BOM and read header manually if needed, DictReader handles it mostly
        ...
        print(f"Import complete! Created {created_count} chapters, Updated {updated_count} chapters.")

if __name__ == '__main__':
    csv_file = r"A:\Pathfinder_student_portal\chapters export with codes.csv"
    import_chapters(csv_file)
