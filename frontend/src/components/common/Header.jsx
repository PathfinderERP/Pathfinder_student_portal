...
const Header = ({ title, subtitle, isSidebarOpen, setSidebarOpen, isDarkMode, toggleTheme, user, logout, actions, accentColor = 'orange' }) => {
        ...
        <header className={`h-20 flex items-center justify-between px-3 lg:px-8 border-b transition-colors duration-300 relative z-40
            ...
            <div className="flex items-center gap-3 lg:gap-6">
                <button
                    ...
                    className={`lg:hidden p-2 rounded-[5px] transition-colors ${isDarkMode ? 'text-slate-400 hover:bg-white/5' : 'text-slate-500 hover:bg-slate-100'}`}
                >
                    <Menu size={22} />
                </button>
