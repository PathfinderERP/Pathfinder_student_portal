            ...
            subItems: [
                ...
                { id: 'admin_parent', label: 'Parent', active: activeTab === 'Admin Parent', onClick: () => setActiveTab('Admin Parent') },
                {
                    ...
                    subItems: [
                        ...
                        { label: 'Chapter', active: activeTab === 'Admin Master Data' && masterSubTab === 'Chapter', onClick: () => { setActiveTab('Admin Master Data'); setMasterSubTab('Chapter'); } },
                        ...
                        { label: 'SubTopic', active: activeTab === 'Admin Master Data' && masterSubTab === 'SubTopic', onClick: () => { setActiveTab('Admin Master Data'); setMasterSubTab('SubTopic'); } },
