...
const PackageDummyPage = ({ title, subtitle, onBack }) => {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className={`p-10 rounded-[5px] border shadow-xl ${isDarkMode ? 'bg-[#10141D] border-white/5' : 'bg-slate-100 border-slate-200 shadow-slate-200/50'}`}>
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    ...
                    <div className="flex items-center gap-3">
                        <button className="px-6 py-3 bg-slate-900 text-white dark:bg-white dark:text-slate-900 rounded-[5px] font-black text-[10px] uppercase tracking-widest hover:scale-105 transition-all active:scale-95 flex items-center gap-2 shadow-xl">
            ...
            {/* Content Section */}
            <div className={`rounded-[5px] border overflow-hidden min-h-[400px] flex flex-col items-center justify-center p-12 text-center ${isDarkMode ? 'bg-[#0B0F17] border-white/5' : 'bg-white border-slate-200'}`}>
                <div className="w-24 h-24 rounded-[5px] bg-purple-500/10 flex items-center justify-center mb-6 animate-bounce">
