                    ...
                    <div className="p-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <button
                                ...
                                className={`flex-1 py-4 rounded-[5px] text-[10px] font-black uppercase tracking-widest border transition-all active:scale-95 ${isDarkMode ? 'bg-white/5 border-white/10 text-slate-400 hover:text-white' : 'bg-slate-50 border-slate-200 text-slate-500 hover:bg-slate-100'} ${isModalLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                disabled={isModalLoading}
                                className={`flex-1 py-4 rounded-[5px] text-[10px] font-black uppercase tracking-widest text-white transition-all active:scale-95 shadow-lg flex items-center justify-center gap-2
                ...
                <div className={`w-full max-w-sm rounded-[5px] shadow-2xl overflow-hidden border ${isDarkMode ? 'bg-[#0F131A] border-white/5 shadow-black/80' : 'bg-white border-slate-200 shadow-slate-300/50'}`}>
                    <div className="p-10 flex flex-col items-center text-center">
                        <div className="mb-6 relative">
                            ...
                            <div className={`relative p-6 rounded-full bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 shadow-inner group overflow-hidden`}>
                                <div className="absolute inset-0 translate-y-full bg-emerald-500/10 group-hover:translate-y-0 transition-transform duration-500"></div>
