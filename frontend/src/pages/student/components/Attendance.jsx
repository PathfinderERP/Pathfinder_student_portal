                    ...
                    {attendanceData.monthlyData.map((month, idx) => (
                        <div key={idx} className={`p-4 rounded-2xl border ${isDarkMode ? 'bg-white/5 border-white/5' : 'bg-slate-50 border-slate-100'}`}>
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <span className={`text-xs font-black px-3 py-1 rounded-full ${month.percentage >= 90
                            ...
                            {/* Progress Bar */}
                            <div className={`mt-3 h-2 rounded-full overflow-hidden ${isDarkMode ? 'bg-white/5' : 'bg-slate-200'}`}>
                                <div
